...
export const dayPlans: DayPlan[] = [
  ...
  },
  {
    ...
    date: "8.13",
    weekday: "목",
    eyebrow: "호텔 조식 · 천하보쌈 · 창덕궁",
    theme: "모아시스에서 아침을 먹고 늦은 점심 뒤 창덕궁 해설을 걷다",
    color: "#0369a1",
    distanceNote: "마곡 → 홍대입구 환승 → 안국·창덕궁",
    summary: "모아시스 조식 · 천하보쌈 · 창덕궁 해설",
    alert: "천하보쌈 식사 종료 15:20경 · 창덕궁에서 약 1시간 해설 관람",
    route: [
      "hotel",
      "cheonhaBossam",
      "changdeokgung",
